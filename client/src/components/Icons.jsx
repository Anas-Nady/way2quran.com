...
export const facebookIcon = (
  <svg
    ...
    y="0px"
    viewBox="0 0 30 30"
    className="w-10 h-10  lg:w-12 lg:h-12   fill-gray-600 dark:fill-slate-50 hover:fill-[#1877F2] dark:hover:fill-[#1877F2]"
  >
...
export const whatsappIcon = (
  <svg
    ...
    y="0px"
    viewBox="0 0 50 50"
    className="w-10 h-10  lg:w-12 lg:h-12  fill-gray-600 dark:fill-slate-50 hover:fill-[#25D366] dark:hover:fill-[#25D366]"
  >
...
export const telegramIcon = (
  <svg
    ...
    y="0px"
    viewBox="0 0 50 50"
    className="w-10 h-10  lg:w-12 lg:h-12  fill-gray-600 dark:fill-slate-50 hover:fill-[#0088cc] dark:hover:fill-[#0088cc]"
  >
...
export const twitterIcon = (
  <svg
    ...
    x="0px"
    y="0px"
    className="w-10 h-10 lg:w-12 lg:h-12 fill-gray-600 dark:fill-slate-50 hover:fill-[#1DA1F2] dark:hover:fill-[#1DA1F2]"
    viewBox="0 0 50 50"
  >
...
export const instagramIcon = (
  <svg
    ...
    y="0px"
    width="100"
    className="fill-gray-600 dark:fill-slate-50 w-10 h-10 lg:w-12 lg:h-12 hover:fill-[#E4405F] dark:hover:fill-[#E4405F]"
    viewBox="0 0 30 30"
  >
...
export const soundCloudIcon = (
  <svg
    ...
    y="0px"
    viewBox="0 0 50 50"
    className="fill-gray-600 dark:fill-slate-50 hover:fill-[#FF5500] dark:hover:fill-[#FF5500] w-10 h-10 lg:w-12 lg:h-12"
  >
...
export const gmailIcon = (
  <svg
    ...
    x="0px"
    y="0px"
    className="w-10 h-10 lg:w-12 lg:h-12 fill-gray-600 dark:fill-slate-50 hover:fill-[#D93025] dark:hover:fill-[#D93025]"
    viewBox="0 0 50 50"
  >
...
export const spinnerIcon = (
  <svg
    aria-hidden="true"
    className="inline w-10 h-10text-gray-200 animate-spin text-slate-300 dark:text-gray-600 fill-blue-600"
    viewBox="0 0 100 101"
    fill="none"
    xmlns="http://www.w3.org/2000/svg"
  >
...
export const deleteReciterIcon = (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
