      ...
      <Layout>
        ...
        >
          <div className="flex flex-wrap gap-2 max-w-screen-2xl items-center mx-auto text-center w-full p-8 ">
            <p
              className="text-3xl sm:text-4xl xl:text-5xl 2xl:text-6xl mx-auto text-gray-900 font-semibold dark:text-white leading-[35px] max-w-[950px]"
              dangerouslySetInnerHTML={{ __html: t("welcomeTxt") }}
            />
            <div className="mx-auto sm:me-auto font-notoNaskhArabic">
              <img
